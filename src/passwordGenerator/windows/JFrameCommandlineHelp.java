...
public class JFrameCommandlineHelp extends JFrame {
	...
	public JFrameCommandlineHelp() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(JFrameAbout.class.getResource("res/Password.png")));
		...
		gl_contentPane
				.setHorizontalGroup(gl_contentPane
						...
						.addGroup(
								gl_contentPane.createSequentialGroup().addGap(138)
										.addComponent(this.btnOk, GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE)
										.addContainerGap(156, Short.MAX_VALUE))
						.addComponent(this.txtpnUsage, GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(
				gl_contentPane.createSequentialGroup()
						.addComponent(this.txtpnUsage, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(this.btnOk)
						.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		this.contentPane.setLayout(gl_contentPane);
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit().getScreenSize();
		java.awt.Dimension DefaultDimension = new java.awt.Dimension(380, 400);
		setBounds((screenSize.width - DefaultDimension.width) / 2, (screenSize.height - DefaultDimension.height) / 2, 380, 400);
	}
}
